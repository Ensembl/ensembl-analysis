...
bsub -q normal \
  ...
  -M 1500 -R"select[mem>1500 && hname!='bc-31-1-07' && hname!='bc-25-1-10' && hname!='bc-25-1-08'] rusage[mem=1500]" \
  -We 30 \
...
bsub -q normal \
  ...
  -M 100 -R"select[mem>100 && hname!='bc-31-1-07' && hname!='bc-25-1-10' && hname!='bc-25-1-08'] rusage[mem=100]" \
...
for list in genes-copy-*; do
  ...
  bsub -q normal \
    ...
    -oo "merge-copy-\${i}.out" \
    -eo "merge-copy-\${i}.err" \
    -M 500 -R"select[mem>500 && hname!='bc-31-1-07' && hname!='bc-25-1-10' && hname!='bc-25-1-08'] rusage[mem=500]" \
