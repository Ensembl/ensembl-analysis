...
sub default_options {
  ...
  return {
    ...
    # BLAST db paths
    'uniprot_blast_db_path'     => '/data/blastdb/Ensembl/uniprot_20XX_XX/uniprot_vertebrata',
    'uniprot_index'             => '/data/blastdb/Ensembl/uniprot_20XX_XX/entry_loc',
    'vertrna_blast_db_path'     => '/data/blastdb/Ensembl/vertrna_xdformat_20XX_XX/embl_vertrna-1',
    'unigene_blast_db_path'     => '/data/blastdb/Ensembl/unigene/unigene',
    
    # alignment annotation on patches
    'uniprot_set'          => '',     # 'human_patch' or 'mouse_patch'
    ...
    'eponine_java_path' => '/software/jdk1.6.0_14/bin/java',
    'eponine_jar_path' => '/software/ensembl/genebuild/usrlocalensembllib/eponine-scan.jar',
    ...
    'genscan_matrix_path' => '/software/ensembl/genebuild/usrlocalensembldata/HumanIso.smat',
    ...
    'cmsearch_exe_path'    => '/software/ensembl/bin/cmsearch_1.0',
    'genblast_path'              => '/software/ensembl/genebuild/bin/genblast/genblast',
