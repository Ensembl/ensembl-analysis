...
my $min_length = 10;
my $species_name;
&GetOptions( 'protfile:s' => \$protfile, 'outfile:s' => \$seqoutfile, 'min_length:n' => \$min_length, 'short_name:s' => \$species_name, );

# usage
if ( !defined $protfile || !defined $seqoutfile ) {
...
my $seqin = new Bio::SeqIO( -file => "<$protfile", -format => "Fasta", );
...
} ## end SEQFETCH: while ( my $prot = $seqin...)
