...
#my $region_details = '24.rs1.re13052829';
...
my $input_gtf_file;# = '/hps/nobackup2/production/ensembl/fergal/production/test_runs/non_verts/butterfly/output_normal/annotation/all_selected_transcripts.gtf';
my $output_gtf_file;# = '/hps/nobackup2/production/ensembl/fergal/production/test_runs/non_verts/butterfly/output_normal/annotation/initial_genes.gtf';
