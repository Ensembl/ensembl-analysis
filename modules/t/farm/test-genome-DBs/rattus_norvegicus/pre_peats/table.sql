...
--
-- Table structure for table `attrib_type_bak`
--
...
--
-- Table structure for table `external_db_bak`
--
...
CREATE TABLE `external_db` (
  ...
  PRIMARY KEY (`external_db_id`),
  UNIQUE KEY `db_name_db_release_idx` (`db_name`,`db_release`)
) ENGINE=MyISAM AUTO_INCREMENT=50836 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `misc_set_bak`
--
...
--
-- Table structure for table `unmapped_reason_bak`
--
