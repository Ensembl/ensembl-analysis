...
package Hive_baboon_genscan_cross_conf;
...
sub default_options {
    ...
    return {
        ...
        'pipeline_name' => 'BaboonGenscanTest',
        ...
        'pipe_dbname' => 'fm2_baboon_genscan_cross_pipe',
        'pipeline_db' => {
        ...
        'reference_db_cross' => {
                            -dbname => 'fm2_baboon_genscan_test',
                            -host   => 'genebuild7',
                            -port   => $self->o('port'),
                            -user   => $self->o('user'),
                            -pass   => $self->o('password'),
...
sub pipeline_analyses {
    ...
    return [
      ...
      {
        -logic_name => 'create_toplevel_ids',
...
#      },
            ...
            {
        -logic_name => 'run_genscan_cross',
        -module     => 'Bio::EnsEMBL::Analysis::Hive::RunnableDB::HiveAssemblyLoading::HiveGenscan',
        -parameters => {
                         target_db => $self->o('reference_db_cross'),
                         logic_name => 'run_genscan_cross',
                         module => 'Bio::EnsEMBL::Analysis::Hive::RunnableDB::HiveAssemblyLoading::HiveGenscan',
                         genscan_path => '/software/ensembl/genebuild/usrlocalensemblbin/genscan',
                         repeat_masking_logic_names => ['repeatmask_repbase_primates'],
                       },
        -rc_name    => 'genscan',
      },
...
sub resource_classes {
    ...
    return {
      ...
      'genscan' => { LSF => '-q normal -M2900 -R"select[mem>2900] rusage[mem=2900,myens_build11tok=10,myens_build12tok=10,myens_build13tok=10]"' },
   }
}
