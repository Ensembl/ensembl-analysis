...
package Hive_final_assembly_loading_conf;
...
'output_path' => '/lustre/scratch109/ensembl/fm2/hive_assembly_loading/final_assembly_loading',
'ftp_link_file' => '/lustre/scratch109/ensembl/fm2/hive_assembly_loading/final_assembly_loading/ftp_link_file.txt',
...
########################
'pipeline_name' => 'baboon_final_assembly',
'pipe_dbname' => 'fm2_baboon_final_assembly_pipe',
'pipe_db_server' => 'genebuild3',
'reference_db_server' => 'genebuild7',
'user' => 'ensadmin',
'password' => 'ensembl',
'port' => 3306,
'driver' => 'mysql',
...
sub resource_classes {
    my $self = shift;
    return {
      'default' => { LSF => '-q normal -M900 -R"select[mem>900] rusage[mem=900,myens_build3tok=10,myens_build7tok=10]"' },
      'repeatmasker' => { LSF => '-q normal -M3900 -R"select[mem>3900] rusage[mem=3900,myens_build3tok=10,myens_build7tok=10]"' },
      'repeatmasker_himem' => { LSF => '-q normal -M6900 -R"select[mem>6900] rusage[mem=6900,myens_build3tok=10,myens_build7tok=10]"' },
      'repeatmasker_long' => { LSF => '-q long -M6900 -R"select[mem>6900] rusage[mem=6900,myens_build3tok=10,myens_build7tok=10]"' },
      'simple_features' => { LSF => '-q normal -M2900 -R"select[mem>2900] rusage[mem=2900,myens_build3tok=10,myens_build7tok=10]"'},
      'genscan' => { LSF => '-q normal -M2900 -R"select[mem>2900] rusage[mem=2900,myens_build3tok=10,myens_build7tok=10]"' },
      'blast' => { LSF => '-q normal -M3900 -n 3 -R "select[mem>3900] rusage[mem=3900,myens_build3tok=10,myens_build7tok=10] span[hosts=1]"' },
    }
}
