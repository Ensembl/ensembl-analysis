...
sub default_options {
    ...
    return {
        ...
        'pipe_dbname' => 'fm2_baboon_mito_load_pipe',
        'pipeline_db' => {
...
sub pipeline_analyses {
    ...
    return [
      ...
      {
        -logic_name => 'baboon_load_mito',
        -module     => 'Bio::EnsEMBL::Analysis::Hive::RunnableDB::HiveAssemblyLoading::HiveLoadMitochondrion',
        -parameters => {
                         target_db => $self->o('reference_db'),
                         enscode_dir => '/nfs/users/nfs_f/fm2/enscode/',
                         output_path => '/lustre/scratch109/ensembl/fm2/hive_assembly_loading/mito_load_test/',
