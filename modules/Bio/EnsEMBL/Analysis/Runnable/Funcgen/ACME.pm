# Ensembl module for Bio::EnsEMBL::Analysis::Runnable::Funcgen::ACME
#
...
# $Source: /tmp/ENSCOPY-ENSEMBL-ANALYSIS/modules/Bio/EnsEMBL/Analysis/Runnable/Funcgen/ACME.pm,v $
# $Version: $
