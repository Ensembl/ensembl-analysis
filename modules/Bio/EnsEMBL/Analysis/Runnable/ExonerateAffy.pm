...
sub parse_results {
  ...
  while (<$fh>) {
    ...
    my $affy_feature = $self->make_affy_feature( $q_id,  $q_start,  $q_end, $q_strand,
                                                 $t_id,  $t_start,  $t_end, $t_strand,
                                                 $score, $q_length, $query_match_length );
...
sub make_affy_feature {
  ...
  my ( $tag, $q_id, $q_start, $q_end, $q_strand, $t_id, $t_start, $t_end, $t_strand, $score, $q_length, $query_match_length ) = @_;
  ...
  my $affy_probe =
    new Bio::EnsEMBL::AffyProbe( -dbID => $q_id, -name => "replace this probe name", -arrayname => "replace this array name", );
  ...
  my $affy_feature = new Bio::EnsEMBL::AffyFeature( -probe         => $affy_probe,
                                                    -start         => $t_start,
                                                    -end           => $t_end,
                                                    -strand        => $t_strand,
