...
has _dbh => ( is => 'ro', isa => 'Object', builder => '_connect', lazy => 1, init_arg => undef, );

has _by_filename_sth => ( is => 'ro', isa => 'Object', builder => '_prepare_by_filename_sth', lazy => 1, init_arg => undef, );
...
sub _entry_from_file {
  ...
  return
    Bio::EnsEMBL::Analysis::Tools::BlastDBTracking::Entry->new(
