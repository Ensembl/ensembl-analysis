# Ensembl module for Bio::EnsEMBL::Analysis::Tools::AllExonOverlapFilter
#
# Copyright (c) 2004 Ensembl
#


package Bio::EnsEMBL::Analysis::Tools::AllExonOverlapFilter;
...
sub new{
  ...
  if (scalar(@args)) {
    throw("AllExonOverlapFilter should have no args in new");
  }
