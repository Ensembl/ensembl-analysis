...
Bio::EnsEMBL::Analysis::Tools::SeqFetcher::OBDAIndexSeqFetcher -
...
Sequences are fetched from a database previously formatted with indicate (https://github.com/Ensembl/ensc-core)
...
# Let the code begin...
package Bio::EnsEMBL::Analysis::Tools::SeqFetcher::OBDAIndexSeqFetcher;
...
use parent qw(Bio::DB::RandomAccessI);
