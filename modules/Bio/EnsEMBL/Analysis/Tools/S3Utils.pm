...
sub get_file_from_s3 {
  ...
  if ( $s3_file =~ m/\.gz/ ) {
    return get_gzip_compressed_file_from_s3( $s3_bucket, $s3_file, $local_dir, $check, $s3_config_file, $md5sum_uncompressed_file );
  }
  else {
...
sub get_gzip_compressed_file_from_s3 {
  ...
  return $outf;
} ## end sub get_gzip_compressed_file_from_s3
...
sub get_uncompressed_file_from_s3 {
  ...
  return $tmp_local_file;
} ## end sub get_uncompressed_file_from_s3
