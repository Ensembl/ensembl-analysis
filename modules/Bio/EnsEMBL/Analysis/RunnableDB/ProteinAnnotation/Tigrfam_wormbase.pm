...
=head1 NAME
  ...
  Bio::EnsEMBL::Analysis::RunnableDB::ProteinAnnotation::Tigrfam_wormbase

=head1 SYNOPSIS

  my $seg = Bio::EnsEMBL::Analysis::RunnableDB::ProteinAnnotation::Tigrfam_wormbase->new ( -db      => $db,
	    	                                                        -input_id   => $input_id,
                                                                        -analysis   => $analysis,
                                                                      );
...
=head1 DESCRIPTION
  ...
  This object wraps Bio::EnsEMBL::Analysis::Runnable::ProteinAnnotation::Tigrfam_wormbase
...
use Bio::EnsEMBL::Analysis::Runnable::ProteinAnnotation::Tigrfam_wormbase;
