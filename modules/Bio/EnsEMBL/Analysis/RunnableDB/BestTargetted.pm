...
sub new {
  ...
  my $seqfetcher = $self->make_seqfetcher( $self->SEQFETCHER_DIR, $self->SEQFETCHER_OBJECT );
...
sub run {
  ...
  my $runnable = Bio::EnsEMBL::Analysis::Runnable::BestTargetted->new( -query                   => $self->query,
