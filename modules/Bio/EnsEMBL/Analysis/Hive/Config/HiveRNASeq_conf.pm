...
sub resource_classes {
    ...
    return {
      ...
      '5GB_rough' => { LSF => lsf_resource_builder('long', 5000, [$self->default_options->{'pipe_db_server'}, $self->default_options->{'rough_output_db_server'}])},
      '15GB_rough' => { LSF => lsf_resource_builder('long', 15000, [$self->default_options->{'pipe_db_server'}, $self->default_options->{'rough_output_db_server'}])},
      ...
      '5GB_introns' => { LSF => lsf_resource_builder('long', 5000, [$self->default_options->{'pipe_db_server'}, $self->default_options->{'rough_output_db_server'}, $self->default_options->{'reference_db_server'}])},
      '10GB_introns' => { LSF => lsf_resource_builder('long', 10000, [$self->default_options->{'pipe_db_server'}, $self->default_options->{'rough_output_db_server'}, $self->default_options->{'reference_db_server'}])},
