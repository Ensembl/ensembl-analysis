...
########################
    ...
    'skip_repeatmodeler'               => '' || $self->o('skip_repeatmodeler'),,                                  # This will decide whether to skip using our repeatmodeler library for the species with repeatmasker. Standard repeatmasker will still run
