...

   {
...

    {
	  ...
	  -logic_name => 'check_transcriptomic_data',
	      ...
	      -flow_into => {
		  1 => ['create_core_db'],
		  2 => ['alternative_annotation_methods'],
	  },
	      -rc_name => 'default',
      },

      {
	  -logic_name => 'alternative_annotation_methods',
	      -module     => 'Bio::EnsEMBL::Hive::RunnableDB::SystemCmd',
	      -parameters => {
		  cmd                     => 'echo insert analyses for Helixer/tiberius/echo'
	  },
	      -rc_name => 'default',
      },
