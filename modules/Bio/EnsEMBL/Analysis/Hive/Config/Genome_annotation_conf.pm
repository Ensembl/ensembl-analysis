...
>>>>>>> experimental/non_verts_annotation
...
# Executable paths
########################
    # 'star_path'              => '/homes/fergal/bin/STAR', ## version 020201 on noah
    # 'stringtie2_path'        => '/homes/fergal/bin/stringtie', ## version 2.1.2 on noah
    ...
    deeptools_bamcoverage_path => '/hps/software/users/ensembl/ensw/C8-MAR21-sandybridge/pyenv/shims/bamCoverage',
...
########################
   ...
   #
    ...
    'lastz_exe'                         => catfile($self->o('binary_base'),'lastz'),
    'axtChain_exe'                      => catfile($self->o('binary_base'),'axtChain'),
    'chainNet_exe'                      => catfile($self->o('binary_base'),'chainNet'),
    'faToNib_exe'                       => catfile($self->o('binary_base'),'faToNib'),
    'lavToAxt_exe'                      => catfile($self->o('binary_base'),'lavToAxt'),
...
# STAR rnaseq
...

      {
        ...
        -parameters => {
          ...
          ' > ' . catfile($self->o('pcp_output'), $self->o('pcp_name')). '.fasta'
        },
...

      {
        ...
        -parameters => {
          cmd => 'sh ' . $self->o('cpc2').' '.
          catfile($self->o('pcp_output'), $self->o('pcp_name')). '.fasta ' .
          catfile($self->o('pcp_output'), $self->o('pcp_name')). '_cpc2'
        },
      },

      {
        ...
        -parameters =>  {
          ...
          catfile($self->o('pcp_output'), $self->o('pcp_name')) . '_RNAsamba.tsv ' .
          catfile($self->o('pcp_output'), $self->o('pcp_name')) .'.fasta ' .
...

      {
        ...
        -parameters => {
          ...
          ' -port ' . $self->o('stringtie_initial_db_port') .
          ' -host ' . $self->o('stringtie_initial_db_server') .
          ' -cpc2 ' . catfile($self->o('pcp_output'), $self->o('pcp_name')) . '_cpc2.txt' .
          ' -rnas ' . catfile($self->o('pcp_output'), $self->o('pcp_name')) . '_RNAsamba.tsv',
        },
        -rc_name    => '1GB',
        -flow_into => {
          '1'    => ['create_pcp_nr_db'],
...
=======
    ...
    'genblast' => { LSF => $self->lsf_resource_builder('production', 3900, [$self->default_options->{'pipe_db_server'}, $self->default_options->{'genblast_db_server'}, $self->default_options->{'dna_db_server'}], [$self->default_options->{'num_tokens'}])},
    'genblast_retry' => { LSF => $self->lsf_resource_builder('production', 4900, [$self->default_options->{'pipe_db_server'}, $self->default_options->{'genblast_db_server'}, $self->default_options->{'dna_db_server'}], [$self->default_options->{'num_tokens'}])},
    ...
    'layer_annotation' => { LSF => $self->lsf_resource_builder('production', 3900, [$self->default_options->{'pipe_db_server'}, $self->default_options->{'genblast_db_server'}, $self->default_options->{'dna_db_server'}], [$self->default_options->{'num_tokens'}])},
    'genebuilder' => { LSF => $self->lsf_resource_builder('production', 1900, [$self->default_options->{'pipe_db_server'}, $self->default_options->{'genblast_db_server'}, $self->default_options->{'dna_db_server'}], [$self->default_options->{'num_tokens'}])},
    'transcript_finalisation' => { LSF => $self->lsf_resource_builder('production', 1900, [$self->default_options->{'pipe_db_server'}, $self->default_options->{'genblast_db_server'}, $self->default_options->{'dna_db_server'}], [$self->default_options->{'num_tokens'}])},
    ...
    '10GB_stringtie' => { LSF => $self->lsf_resource_builder('production', 10000, undef, undef, ($self->default_options->{'stringtie_threads'}))},
>>>>>>> experimental/non_verts_annotation
  }
}
