        ...
        -parameters => {
          ...
          sql => [
            'INSERT INTO meta (species_id, meta_key, meta_value) VALUES '.
              ...
              '(1, "assembly.provider_name", ""),'.
              '(1, "assembly.provider_url", ""),'.
...

      {
        ...
        -parameters => {
          ...
          sql => [
            ...
            'INSERT into analysis (created,logic_name) values (now(),"cdna_alignment_core")',
            ...
            'UPDATE dna_align_feature set analysis_id=(select analysis_id from analysis where logic_name="cdna_alignment_core") where analysis_id=(select analysis_id from analysis where logic_name= in ("exonerate", "cdna2genome", "best_targetted"))'
          ],
        },
        -rc_name    => 'default',
        -flow_into => {
