...
# 4) Finalise steps
...

      {
        ...
        -analysis_capacity => 1,
        -input_ids  => [{'assembly_accession' => 'GCA_905404115.1'},
#                        {'assembly_accession' => 'GCA_905163545.1'},
#                        {'assembly_accession' => 'GCA_905147085.1'},
#                        {'assembly_accession' => 'GCA_905147105.1'},
#                        {'assembly_accession' => 'GCA_905147735.1'},
#                        {'assembly_accession' => 'GCA_905147795.1'},
#                        {'assembly_accession' => 'GCA_905231885.1'},
#                        {'assembly_accession' => 'GCA_905231895.1'},
#                        {'assembly_accession' => 'GCA_905220365.1'},
#                        {'assembly_accession' => 'GCA_905220355.1'},
#                        {'assembly_accession' => 'GCA_905147765.1'},
#                        {'assembly_accession' => 'GCA_905147705.1'},
#                        {'assembly_accession' => 'GCA_905147145.1'},
#                        {'assembly_accession' => 'GCA_905187575.1'},
#                        {'assembly_accession' => 'GCA_905220555.1'},
#                        {'assembly_accession' => 'GCA_905220565.1'},
#                        {'assembly_accession' => 'GCA_905220415.1'},
#                        {'assembly_accession' => 'GCA_905220445.1'},
#                        {'assembly_accession' => 'GCA_905147125.1'},
#                        {'assembly_accession' => 'GCA_905147045.1'},
#                        {'assembly_accession' => 'GCA_905147785.1'},
#                        {'assembly_accession' => 'GCA_905147775.1'},
                                                                    ],
      },
...

      {
        ...
        -flow_into => {
#          '2->A' => {'split_slices_on_intergenic' => {'target_db' => '#core_db#', 'iid' => '#iid#'} },
          '2->A' => {'split_slices_on_intergenic' => INPUT_PLUS() },
	        'A->1' => ['delete_genes'],
        },
        -rc_name => 'default',
      },
...

      {
        ...
        -parameters => {
                          ...
                          ' -inuser '.$self->o('user_r').
                          ' -inhost '.$self->o('clean_utr_db','-host').
                          ' -inport '.$self->o('clean_utr_db','-port').
                          ' -indbname '.'#clean_utr_dbname#'.
                          ' -dnauser '.$self->o('user_r').
                          ' -dnahost '.$self->o('core_db','-host').
                          ' -dnaport '.$self->o('core_db','-port').
                          ' -dnadbname '.'#core_dbname#'.
                          ' -outuser '.$self->o('user').
                          ' -outpass '.$self->o('password').
                          ' -outhost '.$self->o('core_db','-host').
                          ' -outport '.$self->o('core_db','-port').
                          ' -outdbname '.'#core_dbname#'.
                          ' -all'
                        },
        -rc_name    => 'default',
        -flow_into  => {
...
sub resource_classes {
  ...
  return {
    ...
    'busco32' => { LSF => $self->lsf_resource_builder( 'production', 32000, [ $self->default_options->{'pipe_db_server'}, $self->default_options->{'dna_db_server'}], undef, $self->default_options->{'cores'}) },
