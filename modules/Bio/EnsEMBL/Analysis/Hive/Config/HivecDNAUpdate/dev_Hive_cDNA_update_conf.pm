...
##    },
    ...
    {
      -logic_name => 'handover_db_preparation',
      ...
      -parameters => {
        ...
        sql => [
          ...
          "DELETE FROM meta where meta_key in ('xref.timestamp','repeat.analysis','removed_evidence_flag.uniprot_dbversion',". 
          "'removed_evidence_flag.ensembl_dbversion','genebuild.start_date','genebuild.method','genebuild.last_geneset_update',".
          "'genebuild.initial_release_date','genebuild.havana_datafreeze_date','gencode.version','assembly.web_accession_type',".
    ...
    },
    {
      ...
      -wait_for => ['handover_db_preparation'],
      -module => 'Bio::EnsEMBL::Hive::RunnableDB::SystemCmd',
      -parameters => {
#        cmd => 'perl $ENSEMBL_REPO_ROOT/ensembl-production/scripts/production_database/populate_analysis_description.pl'.
#               ' -dp '.$self->o('output_path').
...
#               ' -s homo_sapiens -t cdna'
    ...
    {
      -logic_name => 'run_meta_levels',
      -wait_for => ['update_meta_coord'],
      -module => 'Bio::EnsEMBL::Hive::RunnableDB::SystemCmd',
      -parameters => {
#        cmd => 'perl $ENSEMBL_REPO_ROOT/ensembl-production/scripts/production_database/populate_analysis_description.pl'.
#               ' -dp '.$self->o('output_path').
