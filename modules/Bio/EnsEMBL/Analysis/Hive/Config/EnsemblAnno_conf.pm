...
# 4) Finalise steps
...

     {
        ...
        -parameters => {
                         cmd => 'cp '.catfile($self->o('enscode_root_dir'),'ensembl-analysis/scripts/genebuild/gbiab/support_files/Databases.pm').' '.'##',
             },
        -rc_name => 'default',
        -flow_into  => {
