...
package Hive_rodent_basic_conf;
        ...
        -parameters => {
                         multi_query_download => {
                           ...
                           mouse_pe12 => {
                             ...
                             taxon_id   => $self->o('mouse_taxon_id'),
                             dest_dir   => $self->o('output_path'),
                             compress   => 1,
                             pe_level   => [1,2],},
                           ...
                           rodents_pe12 => {
                             ...
                             taxon_id  => $self->o('rodents_taxon_id'),
                             exclude_id => [$self->o('mouse_taxon_id')],
                             dest_dir  => $self->o('output_path'),
                             compress  => 1,
                             pe_level  => [1,2],
                           },
                           ...
                           mammals_pe12 => {
                             ...
                             exclude_id => [$self->o('mouse_taxon_id'),$self->o('human_taxon_id')],
                             dest_dir   => $self->o('output_path'),
                             compress   => 1,
                             pe_level   => [1,2],
                           },
