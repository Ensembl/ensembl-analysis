  ...
  birds_basic => [
	  ...
	  
    {
              ...
              BIOTYPES   => [
                             ...
                             'human_pe12_sp_1',
                             'human_pe12_tr_1',
                             'hymenoptera_pe12_sp_1',
                             'hymenoptera_pe12_tr_1',
                             'human_pe12_tr_2',
                             'human_pe12_sp_2',
                             'hymenoptera_pe12_sp_2',
                             'hymenoptera_pe12_tr_2',
                             'genblast_rnaseq_top',
                             'projection_4',
                            ],
              FILTER_AGAINST => ['LAYER1','LAYER2'],
    ...
    
    {
              ...
              BIOTYPES   => [
                             'human_pe12_sp_3',
                             'human_pe12_tr_3',
                             'hymenoptera_pe12_sp_3',
                             'hymenoptera_pe12_tr_3',
                             'human_pe12_sp_4',
                             'human_pe12_tr_4',
                             'hymenoptera_pe12_sp_4',
                             'hymenoptera_pe12_tr_4',
                             'genblast_rnaseq_medium',
                            ],
              FILTER_AGAINST => ['LAYER1','LAYER2','LAYER3','LAYER4'],
              DISCARD    => 0,
    ...
    
    {
              ...
              BIOTYPES   => [
                             ...
                             'human_pe12_sp_int_4',
                             'human_pe12_tr_int_4',
                             'hymenoptera_pe12_sp_int_1',
                             'hymenoptera_pe12_tr_int_1',
                             'hymenoptera_pe12_sp_int_2',
                             'hymenoptera_pe12_tr_int_2',
                             'hymenoptera_pe12_sp_int_3',
                             'hymenoptera_pe12_tr_int_3',
                             'hymenoptera_pe12_sp_int_4',
                             'hymenoptera_pe12_tr_int_4',
                             'self_pe3_sp_int_1',
                             'self_pe3_tr_int_1',
                             'self_pe3_sp_int_2',
                             'self_pe3_tr_int_2',
