...
package Bio::EnsEMBL::Analysis::Hive::RunnableDB::HiveAssemblyLoading::HiveTRNAScan;
...
sub fetch_input {
  ...
  my $analysis = Bio::EnsEMBL::Analysis->new( -logic_name   => $self->param('logic_name'),
                                              ...
                                              -program_file => $self->param('trnascan_path'),
  ...
  my $runnable = Bio::EnsEMBL::Analysis::Runnable::tRNAscan_SE->new( -query    => $self->query,
