...
sub load_taxonomy {
  ...
  my $cmd =
    "perl " . $taxonomy_script . " -lcdbhost " . $target_host . " -lcdbuser " .
    $target_user . " -lcdbpass " . $target_pass . " -lcdbname " . $target_dbname . " -lcdbport " . $target_port . " -taxondbhost " .
    $taxonomy_host . " -taxondbport " . $taxonomy_port . " -taxondbname " . $taxonomy_dbname . " -taxon_id " . $taxon_id;
