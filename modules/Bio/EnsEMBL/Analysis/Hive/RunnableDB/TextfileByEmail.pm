...
=head1 NAME
    ...
    Bio::EnsEMBL::Analysis::Hive::RunnableDB::TextfileByEmail
...
=head1 DESCRIPTION
    ...
    This RunnableDB module will send the text in a text file by email after having been optionally processed by a command.
...
package Bio::EnsEMBL::Analysis::Hive::RunnableDB::TextfileByEmail;
