...
%Config = (
           ...
           GENEWISE_CONFIG_BY_LOGIC => 
           {
            ...
            Full_TarGW_GTAG => { 
             ...
             PAF_LOGICNAMES => ['bestpmatch_20'],
             PAF_SOURCE_DB => 'GENEWISE_DB',
             OUTPUT_DB => 'GENEWISE_DB',
             OUTPUT_BIOTYPE => 'full_targw_gtag',
             GENEWISE_PARAMETERS => { 
             ...
             SEQFETCHER_PARAMS => {
                                   -db => ['/lustre/scratch103/ensembl/rn6/platyfishI/proteome/index']
                                  },
             BLASTMINIGENEWISE_PARAMETERS => { -fullseq => 1, },        
            ...
            Full_TarGW_noGTAG => { 
             ...
             PAF_SOURCE_DB => 'GENEWISE_DB',
             OUTPUT_DB => 'GENEWISE_DB',
             OUTPUT_BIOTYPE => 'full_targw_nogtag',
             GENEWISE_PARAMETERS => { 
                                     # pass parameters go genewise here, i.e. -program =>"/usr/local/ensembl/bin/genewiseXXX"
                                     # for more options which can be passed see Runnable/Genewise.pm 
                                     -endbias => 1,
