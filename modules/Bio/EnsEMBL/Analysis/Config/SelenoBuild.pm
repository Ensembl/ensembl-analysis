  ...
  EXONERATE_CONFIG_BY_LOGIC => {
    ...
    exonerate_for_seleno_logicname => {
      ...
      FILTER => { OBJECT     => 'Bio::EnsEMBL::Analysis::Tools::ExonerateTranscriptFilter',
                  PARAMETERS => { -coverage => 50, -percent_id => 50, -best_in_genome => 1, -reject_processed_pseudos => 1, }, },

      COVERAGE_BY_ALIGNED => 1,
      OPTIONS             => "--model est2genome --forwardcoordinates FALSE " .
        "--softmasktarget TRUE --exhaustive FALSE --score 50 " . "--saturatethreshold 100 --dnahspthreshold 60 --dnawordlen 12", },
    seleno_build_logicname => {
      ...
      FILTER => { OBJECT     => 'Bio::EnsEMBL::Analysis::Tools::ExonerateTranscriptFilter',
                  PARAMETERS => { -coverage => 90, -percent_id => 90, -best_in_genome => 1, -reject_processed_pseudos => 1, }, },
