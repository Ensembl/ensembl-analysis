...
%Config = (
  ...
  ARRAY_CONFIG => {
    ...
    IMPORT_AFFY_UTR_ARRAYS => {
      ...
      IFIELDORDER => { -name => 2, -array_chip => 0, -array => 0, -probe_set => 1 },
      ...
      ARRAY_PARAMS => {
        ...
        #EColi
        'E_coli_2' => { -name => 'E_coli_2', -vendor => 'AFFY', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AFFY_UTR' },

        'E_coli_Antisense' =>
          { -name => 'E_coli_Antisense', -vendor => 'AFFY', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AFFY_UTR' },
        #S_aureus

        'S_aureus' => { -name => 'S_aureus', -vendor => 'AFFY', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AFFY_UTR' },

        # plants

        'ATH1-121501' => { -name => 'ATH1-121501', -vendor => 'AFFY', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AFFY_UTR' },

        'Barley1' => { -name => 'Hordeum_vulgare', -vendor => 'AFFY', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AFFY_UTR' },

        'Rice' => { -name => 'Rice', -vendor => 'AFFY', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AFFY_UTR' },

        'Poplar' => { -name => 'Poplar', -vendor => 'AFFY', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AFFY_UTR' },

        'Vitis_Vinifera' =>
          { -name => 'Vitis_Vinifera', -vendor => 'AFFY', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AFFY_UTR' },
    ...
    IMPORT_AFFY_ST_ARRAYS => {
      ...
      IFIELDORDER => { -name => 1, -array_chip => 0, -array => 0, -probe_set => 2, },
    ...
    IMPORT_AGILENT_ARRAYS => {
      ...
      ARRAY_PARAMS => {    #Danio
        ...
        #plant - potato
        'A-MEXP-2203' =>
          { -name => 'A-MEXP-2203', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },
        ...
        '012795'   => { -name => '012795',   -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },
        '015061'   => { -name => '015061',   -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },
        '020186'   => { -name => '020186',   -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },
        'GPL13394' => { -name => 'GPL13394', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },

        'GPL14144' => { -name => 'GPL14144', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },

        'GPL8304' => { -name => 'GPL8304', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },

        # C.briggsae

        'GPL14143' => { -name => 'GPL14143', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },

        'GPL8303' => { -name => 'GPL8303', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },

        # C. brenneri

        'GPL14142' => { -name => 'GPL14142', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },

        # C. remanei

        'GPL14146' => { -name => 'GPL14146', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },

        # C. japonica

        'GPL14145' => { -name => 'GPL14145', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },

        # P. pacificus

        'GPL14372' => { -name => 'GPL14372', -vendor => 'AGILENT', -format => 'EXPRESSION', -type => 'OLIGO', -class => 'AGILENT', },
    ...
    IMPORT_WUSTL_ARRAYS => {
      ...
      IFIELDORDER => { -name => 1, -array_chip => 0, -array => 0, },
    ...
    IMPORT_STEMPLE_LAB_SANGER_ARRAYS => {
      ...
      IFIELDORDER => { -name => 1, -array_chip => 0, -array => 0, -description => 2, },
