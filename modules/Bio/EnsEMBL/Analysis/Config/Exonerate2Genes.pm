...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
    ...
    cdna_update => {
      ...
      GENOMICSEQS => '/data/blastdb/Ensembl/Human/GRCh38/genome/softmasked_dusted/toplevel.with_nonref_and_GRCh38_p7.no_duplicate.softmasked_dusted.fa',
      KILL_TYPE => undef,
      OPTIONS => '--model est2genome --forwardcoordinates FALSE --softmasktarget TRUE --exhaustive FALSE  --score 500 --saturatethreshold 100 --dnahspthreshold 60 --dnawordlen 14',
      OUTDB => 'ESTCDNA_DB',
      QUERYSEQS => '/lustre/scratch109/sanger/cgg/cdna_update_human85/chunks',
      QUERYTYPE => 'dna',
      USE_KILL_LIST => 0
    },
    cdna_update_2 => {
      ...
      OUTDB => 'ESTCDNA_DB',
      QUERYSEQS => '/lustre/scratch109/sanger/cgg/cdna_update_human85/chunks2',
      QUERYTYPE => 'dna',
      USE_KILL_LIST => 0
    },
    cdna_update_3 => {
      ...
      OPTIONS => '--model est2genome --forwardcoordinates FALSE --maxintron 400000 --bestn 10 --softmasktarget FALSE --exhaustive FALSE  --score 500 --saturatethreshold 100 --dnahspthreshold 60 --dnawordlen 14',
      OUTDB => 'ESTCDNA_DB',
      QUERYSEQS => '/lustre/scratch109/sanger/cgg/cdna_update_human85/chunks3',
      QUERYTYPE => 'dna',
      USE_KILL_LIST => 0
    },
    orthologue_recovery => {
